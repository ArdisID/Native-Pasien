<html>
    ...
    <body>
        ...
        <div class="row nt-3">
            <div class="col">
                <table class="table table-striped table-hover tabel-sn">
                    <tr>
                        <th>No</th>
                        <th>ID Pasien</th>
                        <th>Nama Pasien</th>
                    ...
                    <tr>
                        ...
                        <td><?= $row['jk']?></td>
                        <td><?= $row['alamat']?></td>
                        <td><a href="editpasien.php?edit=<?= $row['idPasien']; ?>" class="btn btn-warning btn-sn">Edit</a><a href="koneksi.php?idPasien=<?= $row['idPasien']; ?>" class="btn btn-danger btn-sn">Hapus</a></td>
                    </tr>
                    <?php } ?>
                </table>
            </div>
